  ...
  createGiftCards: {
    ...
    resolve: async (_, { emails, numberOfGiftCards, ...args }, req) => {
      ...
      if (args.limitedToOpenSourceCollectives) {
        ...
        if (!openSourceHost) {
          throw new Error(
            'Cannot find the host "Open Source Collective". You can disable the opensource-only limitation, or contact us at support@qpayee.com if this keeps happening',
          );
        }
