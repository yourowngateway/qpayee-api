...
`);
  ...
  describe('sanitizeHTML + buildSanitizerOptions', () => {
    ...
    it('redirects unstrusted domains', () => {
      ...
      expect(sanitizeHTML('<a href="qpayee.com.malicious.com">Test</a>', sanitizerOptions)).to.eq(
        '<a href="http://localhost:3000/redirect?url=https%3A%2F%2Fqpayee.com.malicious.com">Test</a>',
      );
      expect(sanitizeHTML('<a href="maliciousqpayee.com">Test</a>', sanitizerOptions)).to.eq(
        '<a href="http://localhost:3000/redirect?url=https%3A%2F%2Fmaliciousqpayee.com">Test</a>',
      );
    });

    it('does not redirect trusted domains', () => {
      const testUrls = [
        '<a href="https://qpayee.com/toto">Test</a>',
        '<a href="https://docs.qpayee.com/toto">Test</a>',
